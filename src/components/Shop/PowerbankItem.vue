                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>{{ powerbankData.capacity }}</td>
                          </tr>
                          <tr>
                            <th scope="row">Ağırlık</th>
                            <td>{{ powerbankData.weight }}</td>
                          </tr>
                          <tr>
                            <th scope="row">Çıkış Tipi</th>
                            <td>{{ powerbankData.output }}</td>
                          </tr>
                          <tr>
                            <th scope="row">Hızlı Şarj</th>
                            <td>{{ powerbankData.fastCharge }}</td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
...
export default {
  ...
  methods: {
    async getData() {
      await this.$appAxios
        .get(`/DeviceDetails/GetPowerbankDetail?deviceId=${this.deviceData.id}`)
        .then((response) => {
          console.log(response);
          this.powerbankData = response.data;
        })
        .catch((error) => {
          console.log(error);
        });
